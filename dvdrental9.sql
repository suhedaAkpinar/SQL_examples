...
SELECT payment_id,first_name, last_name FROM customer INNER JOIN payment ON customer.payment_id=payment.id;


--SORU 3

SELECT rental_id, first_name, last_name FROM customer INNER JOIN rental ON customer.rental_id=rental.id;
